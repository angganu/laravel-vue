...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        $this->insertLink('user,admin', 'Employee', '/employee', 'cil-user');
        $this->beginDropdown('user,admin', 'Master Barang', '/', 'cil-layers');
            $this->insertLink('user,admin', 'Barang', '/barang');
            $this->insertLink('user,admin', 'Satuan', '/satuan');
        $this->endDropdown();
        $this->beginDropdown('user,admin', 'Inventory', '/', 'cil-pencil');
            $this->insertLink('user,admin', 'Inventory Request', '/inventory');
            $this->insertLink('user,admin', 'Lokasi Inventory', '/lokasi');
        $this->endDropdown();
        ...
        $this->menuId = DB::getPdo()->lastInsertId();  //set menuId
        $this->beginDropdown('user,admin', 'Pages');
            $this->insertLink('user,admin', 'Dashboard',    '/');
